...
if [[ -x "$ROOT/tests/map_plane_header_bytes_selftest.sh" ]]; then
  "$ROOT/tests/map_plane_header_bytes_selftest.sh"
fi
if [[ -x "$ROOT/tests/map_helper_selftest.sh" ]]; then
  "$ROOT/tests/map_helper_selftest.sh"
fi
if [[ -x "$ROOT/tests/map_summary_helper_selftest.sh" ]]; then
  "$ROOT/tests/map_summary_helper_selftest.sh"
fi
...
if [[ -x "$ROOT/tests/map_loaded_validation_helper_selftest.sh" ]]; then
  "$ROOT/tests/map_loaded_validation_helper_selftest.sh"
fi
...
if [[ -x "$ROOT/tests/map_load_catalog_validation.sh" ]]; then
  "$ROOT/tests/map_load_catalog_validation.sh"
fi
...
if [[ -x "$ROOT/tests/present_map_plane_stats_inspection.sh" ]]; then
  "$ROOT/tests/present_map_plane_stats_inspection.sh"
fi
if [[ -x "$ROOT/tests/present_map_plane_table_inspection.sh" ]]; then
  "$ROOT/tests/present_map_plane_table_inspection.sh"
fi
if [[ -x "$ROOT/tests/present_map_plane_table_catalog.sh" ]]; then
  "$ROOT/tests/present_map_plane_table_catalog.sh"
fi
...
if [[ -x "$ROOT/tests/present_map_cli_overflow_validation.sh" ]]; then
  "$ROOT/tests/present_map_cli_overflow_validation.sh"
fi
